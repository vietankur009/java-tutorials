...
/**
 * This class will be used to print a pyramid structure.
 *       *
 *      * *
 *     * * *
 *    * * * *
 *   * * * * *
 */
public class MiddleStarPatten {
    public static void main(String... arg){
        printStarPyramid(5,4);
    }
     ...
     */
    public static void printStarPyramid(int rows, int column){
